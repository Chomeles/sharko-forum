...
class Shout(models.Model):
    """A single line in the front-page shoutbox. Posting is gated to Member+ (see
    views.can_shout); reading is public."""
    author = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT, related_name="shouts")
